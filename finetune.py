...
from utils.model_utils import load_from_checkpoint,trainer_save_model,compute_accuracy
from utils.load_model import MyWhisperForConditionalGeneration,match_modules,match_modules_string
...
# device_map = 'cpu'
# 获取模型
if args.modal=='speech':
    model=WhisperForConditionalGeneration.from_pretrained(args.base_model,
                                                        load_in_8bit=args.use_8bit,
                                                        device_map=device_map,
                                                        local_files_only=args.local_files_only,)
elif args.modal=='eeg':
    model=MyWhisperForConditionalGeneration.from_pretrained(args.base_model,
                                                        load_in_8bit=args.use_8bit,
                                                        device_map=device_map,
                                                        local_files_only=args.local_files_only,
                                                        modal_ch=args.eeg_ch)
...
if args.modal=='speech':
    ...
    model.pre_conv1.register_forward_hook(make_inputs_require_grad)
else:
    raise NotImplementedError
...
if args.resume_from_checkpoint:
    ...
    # modules_to_save= [".*pre_conv",".*model.encoder.conv1",".*model.encoder.conv2"]
    if args.modal == 'speech':
...
for name,param in model.named_parameters():
    if name in params_to_no_grad:
        param.requires_grad=False
# base_model.model.pre_conv.original_module.weight
# base_model.model.pre_conv.original_module.bias
# base_model.model.pre_conv.modules_to_save.default.weight
# base_model.model.pre_conv.modules_to_save.default.bias
# base_model.model.model.encoder.conv1.original_module.weight
# base_model.model.model.encoder.conv1.original_module.bias
# base_model.model.model.encoder.conv1.modules_to_save.default.weight
# base_model.model.model.encoder.conv1.modules_to_save.default.bias
# base_model.model.model.encoder.conv2.original_module.weight
# base_model.model.model.encoder.conv2.original_module.bias
# base_model.model.model.encoder.conv2.modules_to_save.default.weight
# base_model.model.model.encoder.conv2.modules_to_save.default.bias

# 0 base_model.model.pre_conv.original_module.weight
# 1 base_model.model.pre_conv.original_module.bias
# 4 base_model.model.model.encoder.conv1.original_module.weight
# 5 base_model.model.model.encoder.conv1.original_module.bias
# 8 base_model.model.model.encoder.conv2.original_module.weight
# 9 base_model.model.model.encoder.conv2.original_module.bias
...
trainer._save = trainer_save_model
