...
if __name__ == '__main__':
    ...
    input_jsonl='datasets/gwilliams2023/preprocess5/info.jsonl'
    output_dir='datasets/gwilliams2023/preprocess5/split4'
    mix_train_val=True
    ...
    for s in story_list:
        seq_ids=[]
        story_data=[data for data in datas if data['story'] ==s]
